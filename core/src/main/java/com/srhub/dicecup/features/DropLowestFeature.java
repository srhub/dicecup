...
/**
 * Drop the lowest dice from the dice roll.
 *
 * @author Oliver Schrenk <oliver.schrenk@gmail.com>
 */
class DropLowestFeature extends AbstractFeature {
	 ...
	 *            the n
	 */
	public DropLowestFeature(final int n) {
		this.n = n;
	}
	...
	public boolean equals(final Object obj) {
		...
		final DropLowestFeature other = (DropLowestFeature) obj;
		if (n != other.n) {
			return false;
		}
		return true;
