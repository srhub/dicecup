...
/**
 * Multiply each dice by a constant
 *
 * @author Oliver Schrenk <oliver.schrenk@gmail.com>
 */
class MultiplyConstantFeature extends AbstractFeature {
	 ...
	 *            the constant
	 */
	public MultiplyConstantFeature(final int constant) {
	...
	public String toString() {
		return "MultiplyConstantFeature [constant=" + constant + "]";
	}
